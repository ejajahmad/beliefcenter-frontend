...
export default function PostForm() {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <p className="bg-gray-50 text-gray-700 text-sm mb-4 px-2 py-1 border border-gray-100 rounded-lg flex items-center gap-1 justify-center">
        <MdPrivacyTip className="text-blue-500" /> We do not spam. We value your privacy.
      </p>
